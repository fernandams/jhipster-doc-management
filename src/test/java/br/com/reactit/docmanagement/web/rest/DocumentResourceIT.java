...
class DocumentResourceIT {
    ...
    void createDocument() throws Exception {
        ...
        assertThat(testDocument.getUploaded()).isEqualTo(DEFAULT_UPLOADED);
    }
    ...
    void putExistingDocument() throws Exception {
        ...
        assertThat(testDocument.getUploaded()).isEqualTo(UPDATED_UPLOADED);
    }
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.description(UPDATED_DESCRIPTION).uploaded(UPDATED_UPLOADED);
